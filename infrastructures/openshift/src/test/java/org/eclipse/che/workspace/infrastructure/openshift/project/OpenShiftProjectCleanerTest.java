...
public class OpenShiftProjectCleanerTest {
  ...
  //    openShiftProjectCleaner =
  //        spy(new OpenShiftProjectCleaner(false, PROJECT_NAME, PVC_NAME, clientFactory));
  //
  ...
  //
  //    verify(eventService,
  // times(1)).subscribe(any(DeleteOpenShiftProjectOnWorkspaceRemove.class));
  //  }
  //
  //  @Test
  ...
  //
  //    verify(eventService,
  // times(1)).subscribe(any(DeleteOpenShiftProjectPvcOnWorkspaceRemove.class));
  //  }
  //
  //  @Test
