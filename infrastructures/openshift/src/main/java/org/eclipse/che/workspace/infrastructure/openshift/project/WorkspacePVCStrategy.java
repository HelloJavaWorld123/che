...
/**
 * Defined set of supported strategies for workspace PVCs.
 *
...
public interface WorkspacePVCStrategy {
  ...
  /**
   * Prepares PVC for backup of workspace data on a specified machine and in strategy specific way.
   *
   ...
   * @param machineName the name of machine with workspace persisted data
   * @throws InfrastructureException when any error while preparation occurs
   */
  void prepare(OpenShiftEnvironment osEnv, String workspaceId, String machineName)
